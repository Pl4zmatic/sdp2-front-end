  ...
  return (
    <div className="flex py-[10px] ml-2 mt-2 border-l-4">
      ...
      <div className="flex flex-col justify-center items-end p-5">
        ...
        <div>
          <Dialog>
            <DialogTrigger className="w-auto bg-white/10 hover:bg-white/20 dark:bg-lightNavy dark:hover:bg-navy border-0 transition-colors text-white mt-5 p-2 px-6 rounded-md">
